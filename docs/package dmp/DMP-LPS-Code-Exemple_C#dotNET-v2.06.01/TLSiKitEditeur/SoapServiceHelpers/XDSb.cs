...
namespace TLSiKitEditeur.SoapServiceHelpers
{
    public static  class XDSb
    {
        ...
        public static XmlDocument loadCDADocument()
        {
            ...
            document.Load(Dmp.CDA_TEMPLATE);
            // Modification du CDA pour le rendre unique
            XmlNodeList l = document.GetElementsByTagName("text");
            String strDoc = "Bonjour " + DateTime.Now.ToLongDateString() + " " + DateTime.Now.ToLongTimeString();
            ASCIIEncoding encoding = new ASCIIEncoding();
            byte[] bDoc = encoding.GetBytes(strDoc);
            l[0].InnerText = System.Convert.ToBase64String(bDoc);
            return document;
        }
        ...
        public static SubmitObjectsRequest createXDSb(string patientID, string submissionSet_OID, string documentOID, string signatureOID, string authorPerson, string Identifiant_Structure)
        {
            ...
            ClassificationType[] classificationsExtrinsicObjectDocument1 = new ClassificationType[]{
                ...
                createClassification("urn:uuid:2c6b8cb7-8b2a-4051-b291-b1ae6a575ef4","Document01","cla68","H33",new SlotType1[]{createSlot("codingScheme","2.16.840.1.113883.6.3")},"Décollement et déchirement de la rétine"),
                ...
                createClassification("urn:uuid:f0306f51-975f-434e-a61c-c59651d33983","Document01","cla65","27899-4",new SlotType1[]{createSlot("codingScheme","2.16.840.1.113883.6.1")},"CR d'acte diagnostique (autre)")
            };
