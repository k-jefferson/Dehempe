...
{
    public class DocumentRepositorySoapService : IDisposable
    {
        private DocumentRepository_PortTypeClient _service;

        public DocumentRepositorySoapService()
        {
        ...
        public void RetrieveDocumentSet()
        {
            ...
            request[0].RepositoryUniqueId = "1.2.250.1.213.4.1.1.1.4";
